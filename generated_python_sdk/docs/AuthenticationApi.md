# canvas_lms_sdk.AuthenticationApi

All URIs are relative to *https://canvas.instructure.com/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**api_lti_accounts_account_id_authorize_post**](AuthenticationApi.md#api_lti_accounts_account_id_authorize_post) | **POST** /api/lti/accounts/{account_id}/authorize | Retrieve a JWT access token
...
with canvas_lms_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = canvas_lms_sdk.AuthenticationApi(api_client)
    ...
    try:
        ...
        print("The response of AuthenticationApi->api_lti_accounts_account_id_authorize_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthenticationApi->api_lti_accounts_account_id_authorize_post: %s\n" % e)
```
