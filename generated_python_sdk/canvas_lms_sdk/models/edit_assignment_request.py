...
class EditAssignmentRequest(BaseModel):
    ...
    """ # noqa: E501
    assignment: Optional[EditAssignmentRequestAssignment] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignment": EditAssignmentRequestAssignment.from_dict(obj["assignment"]) if obj.get("assignment") is not None else None
        })
        return _obj
