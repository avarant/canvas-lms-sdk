...
class NewQuiz(BaseModel):
    ...
    assignment_group_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "instructions", "assignment_group_id", "points_possible", "due_at", "lock_at", "unlock_at", "published", "grading_type", "quiz_settings"]
