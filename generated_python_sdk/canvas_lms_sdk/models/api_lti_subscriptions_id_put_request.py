...
class ApiLtiSubscriptionsIdPutRequest(BaseModel):
    """
    ApiLtiSubscriptionsIdPutRequest
    """ # noqa: E501
    subscription: Optional[ApiLtiSubscriptionsIdPutRequestSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": ApiLtiSubscriptionsIdPutRequestSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
