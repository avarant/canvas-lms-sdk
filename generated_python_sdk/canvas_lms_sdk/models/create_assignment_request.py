...
class CreateAssignmentRequest(BaseModel):
    ...
    """ # noqa: E501
    assignment: Optional[CreateAssignmentRequestAssignment] = None
    __properties: ClassVar[List[str]] = ["assignment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignment": CreateAssignmentRequestAssignment.from_dict(obj["assignment"]) if obj.get("assignment") is not None else None
        })
        return _obj
