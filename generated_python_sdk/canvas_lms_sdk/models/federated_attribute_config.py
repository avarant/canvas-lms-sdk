...
class FederatedAttributeConfig(BaseModel):
    ...
    provisioning_only: Optional[StrictBool] = None
    autoconfirm: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["attribute", "provisioning_only", "autoconfirm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "provisioning_only": obj.get("provisioning_only"),
