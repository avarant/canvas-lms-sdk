...
class ApiLtiSubscriptionsPostRequestSubscriptionTransportMetadata(BaseModel):
    """
    An object with a single key - 'Url'.
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The endpoint URL or queue identifier to receive events.", alias="Url")
