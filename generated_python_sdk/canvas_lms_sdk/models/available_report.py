...
class AvailableReport(BaseModel):
    ...
    AvailableReport
    """ # noqa: E501
    report: Optional[StrictStr] = Field(default=None, description="The name of the report.")
    title: Optional[StrictStr] = Field(default=None, description="The human-readable title of the report.")
    parameters: Optional[Dict[str, AvailableReportParametersValue]] = Field(default=None, description="The parameters will vary for each report.")
    __properties: ClassVar[List[str]] = ["report", "title", "parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "parameters": dict(
                (_k, AvailableReportParametersValue.from_dict(_v))
