...
class QuizSubmissionQuestionInput(BaseModel):
    """
    QuizSubmissionQuestionInput
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the QuizQuestion this answer is for.")
    answer: Optional[QuizSubmissionQuestionInputAnswer]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "answer": QuizSubmissionQuestionInputAnswer.from_dict(obj["answer"]) if obj.get("answer") is not None else None
        })
        return _obj
