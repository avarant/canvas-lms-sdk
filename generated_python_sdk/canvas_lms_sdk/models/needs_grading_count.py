...
class NeedsGradingCount(BaseModel):
    ...
    """ # noqa: E501
    section_id: StrictStr = Field(description="The section ID.")
    needs_grading_count: StrictInt = Field(description="Number of submissions that need grading in this section.")
    __properties: ClassVar[List[str]] = ["section_id", "needs_grading_count"]
