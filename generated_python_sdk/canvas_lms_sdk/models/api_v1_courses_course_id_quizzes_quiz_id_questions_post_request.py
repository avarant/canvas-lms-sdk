...
class ApiV1CoursesCourseIdQuizzesQuizIdQuestionsPostRequest(BaseModel):
    """
    ApiV1CoursesCourseIdQuizzesQuizIdQuestionsPostRequest
    """ # noqa: E501
    question: Optional[QuizQuestionInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "question": QuizQuestionInput.from_dict(obj["question"]) if obj.get("question") is not None else None
        })
        return _obj
