...
class AccountsAccountIdLtiRegistrationsIdBindPostRequest(BaseModel):
    """
    AccountsAccountIdLtiRegistrationsIdBindPostRequest
    """ # noqa: E501
    workflow_state: StrictStr = Field(description="The desired state for this registration/account binding.")
    __properties: ClassVar[List[str]] = ["workflow_state"]
