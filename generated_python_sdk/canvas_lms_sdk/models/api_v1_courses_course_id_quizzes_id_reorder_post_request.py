...
class ApiV1CoursesCourseIdQuizzesIdReorderPostRequest(BaseModel):
    """
    ApiV1CoursesCourseIdQuizzesIdReorderPostRequest
    """ # noqa: E501
    order: Optional[List[ApiV1CoursesCourseIdQuizzesIdReorderPostRequestOrderInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": [ApiV1CoursesCourseIdQuizzesIdReorderPostRequestOrderInner.from_dict(_item) for _item in obj["order"]] if obj.get("order") is not None else None
        })
        return _obj
