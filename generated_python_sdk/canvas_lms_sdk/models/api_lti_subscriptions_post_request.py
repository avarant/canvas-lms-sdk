...
class ApiLtiSubscriptionsPostRequest(BaseModel):
    """
    ApiLtiSubscriptionsPostRequest
    """ # noqa: E501
    subscription: Optional[ApiLtiSubscriptionsPostRequestSubscription] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscription": ApiLtiSubscriptionsPostRequestSubscription.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
        return _obj
